...
var screen = document.querySelector("main .lax .second .screen");
var screenTitle = document.querySelector("main .lax .second .container .name b");
var screenText = document.querySelector("main .lax .second .container .name p");

function goBig(v) {
    screen.style.backgroundImage = "url('" + v.src + "')";
    screenText.innerHTML = v.alt;
    screenTitle.innerHTML = v.title;
}
