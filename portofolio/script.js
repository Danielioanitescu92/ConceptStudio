...
var videoclip = document.querySelector("main .lax .second .player video");
var songTitle = document.querySelector("main .lax .second .player .name");
var videoTitle = document.querySelector("main .lax .second .player .name b");
var videoSong = document.querySelector("main .lax .second .player .name p");
var a = "../assets/headers/person-singing-1370545.jpg";
var b = "../assets/headers/group-of-teens-singing-1845085.jpg";
var c = "../assets/headers/man-standing-surrounded-with-smoke-1916818.jpg";
var d = "../assets/headers/man-standing-while-singing-2067677.jpg";
...
//Change video and poster 

function poster(y){
    videoclip.setAttribute("poster", y);
    songTitle.style.visibility = "visible";
    songTitle.style.opacity = "1";
    songTitle.style.transition = "0.1s";

    if (y == a) {
        console.log("one");
        videoclip.src = "../assets/one.mp4";
        videoTitle.innerText = "MR. SINGER & MISS STAR";
        videoSong.innerText = "One New Song \n Killer Beats Studio";
    } else if (y == b) {
        console.log("two");
        videoclip.src = "../assets/two.mp4";
        videoTitle.innerText = "TEENAGERS";
        videoSong.innerText = "We're cool \n Killer Beats Studio";
    } else if (y == c) {
        console.log("three");
        videoclip.src = "../assets/three.mp4";
        videoTitle.innerText = "SMOKE GUY";
        videoSong.innerText = "I'm on fire \n Killer Beats Studio";
    } else if (y == d) {
        console.log("four");
        videoclip.src = "../assets/four.mp4";
        videoTitle.innerText = "G-GANG";
        videoSong.innerText = "Awesomeous \n Killer Beats Studio";
    } else if (y == e) {
        console.log("five");
        videoclip.src = "../assets/five.mp4";
        videoTitle.innerText = "SUPERSTAR";
        videoSong.innerText = "Another Tune \n Killer Beats Studio";
    } else if (y == f) {
        console.log("six");
        videoclip.src = "../assets/six.mp4";
        videoTitle.innerText = "THE GUITARIST";
        videoSong.innerText = "Notes on music \n Killer Beats Studio";
    } else if (y == g) {
        console.log("seven");
        videoclip.src = "../assets/seven.mp4";
        videoTitle.innerText = "THE NEW GUY";
        videoSong.innerText = "Bomb Track \n Killer Beats Studio";
    };

    setTimeout(function poster(y) {
        songTitle.style.visibility = "hidden";
        songTitle.style.opacity = "0";
        songTitle.style.transition = "0.5s";
    }, 2000);
};

/*-----------------SCROLL PORTOFOLIO--------------*/

var runner = document.querySelector("main .lax .second .list");

function runRight() {
    console.log("go right");
    sideScroll(runner,'right',7,1000,10);
};

function runLeft() {
    console.log("go left");
    sideScroll(runner,'left',7,1000,10);
};
